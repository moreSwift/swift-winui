...
enum __x_ABI_CMicrosoft_CWindows_CApplicationModel_CWindowsAppRuntime_CRuntimeCompatibilityChange
    ...
    __x_ABI_CMicrosoft_CWindows_CApplicationModel_CWindowsAppRuntime_CRuntimeCompatibilityChange_AppWindow_NoDidPresenterChangeOnRestore = 58567549,
    __x_ABI_CMicrosoft_CWindows_CApplicationModel_CWindowsAppRuntime_CRuntimeCompatibilityChange_DesktopSiteBridge_ActivationErrorCrash = 58821687,
    __x_ABI_CMicrosoft_CWindows_CApplicationModel_CWindowsAppRuntime_CRuntimeCompatibilityChange_DispatcherQueue_PropagateException = 58472221,
    __x_ABI_CMicrosoft_CWindows_CApplicationModel_CWindowsAppRuntime_CRuntimeCompatibilityChange_GetIntermediatePointsImpl_Crash = 58768401,
    __x_ABI_CMicrosoft_CWindows_CApplicationModel_CWindowsAppRuntime_CRuntimeCompatibilityChange_InputPointerSource_ReentrantDisposedCrash = 58635438,
    __x_ABI_CMicrosoft_CWindows_CApplicationModel_CWindowsAppRuntime_CRuntimeCompatibilityChange_NavigationView_ClearSelectedItem = 58987595,
    __x_ABI_CMicrosoft_CWindows_CApplicationModel_CWindowsAppRuntime_CRuntimeCompatibilityChange_XamlIsland_ExitNonClientArea = 58987663,
};
